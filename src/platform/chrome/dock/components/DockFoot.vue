...
<template>
    ...
    <div class="usf-dock__persistent-foot" data-testid="dock-persistent-foot">
        ...
        <template v-if="!isPhone">
            ...
            <!-- ⑤ Dark-mode toggle + the collapse toggle — `size="dock"` routes the toggle glyph
                 through the dock-control register; `:disable-transitions` wires the INSTANT theme
                 re-print. Beside it, the GEAR-TOGGLED COLLAPSE control (C26): this control toggles
                 the re-enabled collapse posture (the orchestrator drives the GlassDock
                 `expand()`/`collapse()`). Fenced into its own zone below the divider above. -->
